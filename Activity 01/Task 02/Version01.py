...
class TaskManagerApp:
    ...
    def create_widgets(self):
        ...
        self.task_listbox = tk.Listbox(self.task_frame, width=50, height=10, font=self.text_font)
        ...
        self.data_text = scrolledtext.ScrolledText(self.data_frame, wrap=tk.WORD, width=50, height=10, font=self.text_font)
    ...
    def add_task(self):
        ...
        if title:
            ...
            if deadline:
                ...
                task = f"{task_number}. {title} - {deadline}"
    ...
    def edit_task(self):
        ...
        if selected_task_index:
            ...
            if new_title:
                new_deadline = simpledialog.askstring("Edit Task", "Edit task deadline (YYYY-MM-DD):", initialvalue=selected_task.split(" - ")[1])
                if new_deadline:
                    updated_task = f"{task_number}. {new_title} - {new_deadline}"
